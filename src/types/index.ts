...
export interface Settings{theme:'light'|'dark'|'system';interfaceLanguage:'ru'|'en'|'de';defaultLanguage:StudyLanguage;learnerLevel:CefrLevel;cardsPerSession:number;showExamples:boolean;shuffle:boolean;reverse:boolean;autoCategory:boolean}
