...
const keys={words:'language_app_words_v1',categories:'language_app_categories_v1',sessions:'language_app_sessions_v1',settings:'language_app_settings_v1',meta:'language_app_meta_v1',seenDaily:'language_app_seen_daily_v1'};
